...
;(function () {
  ...
  lpc_template.queue.formInputs = function ($self) {
	...
	lpc_template.queue.lpcSliderMagic = function ($self) {
		...
		if(paramsGet.has('lpc_test')){	
			if(typeof ReactLPConstructor == 'object') {
				var $block = $self.find('.magic-slider') ? $self : $self.hasClass('.magic-slider');
			}else {
	...
	lpc_template.queue.lpcDecorText = function ($self) {
		...
		if(paramsGet.has('lpc_test')){	
			if(typeof ReactLPConstructor == 'object') {
				var $block = $self.find('.lpc-elements-dynamic-headline') ? $self : $self.hasClass('.lpc-elements-dynamic-headline');
			}else {
    ...
    setTimeout(function () {
	    ...
	    document.querySelectorAll('.has_custom_bg').forEach(function (element) {
	        ...
	        if (bgColor === "transparent" || alpha === 0) {
	            ...
	            element.querySelectorAll('[data-elem-type="text"], [data-elem-type="header"], [data-elem-type="generate"]').forEach(function (innerElem) {
